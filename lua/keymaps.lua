...
-- Keep the cursor in the middle while moveing accross search
vim.keymap.set('n', 'n', 'nzzzv')
vim.keymap.set('n', 'N', 'Nzzzv')

-- Pasting while keep the copyed text in the buffer
vim.keymap.set('x', '<leader>p', [["_dP]])

-- Move half page and keep cursor in the middle
